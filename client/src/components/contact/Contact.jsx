...
function Contact() {
  ...
  function sendEmail(e) {
    ...
    setSending(true);
    emailjs
      .sendForm("React-Reyzon", "foodzoone", form.current, "r_hRLdvYYGgJ3FBa-")
      .then(
        (result) => {
  ...
  return (
    <div className="contact global flex flex-col items-center justify-center  relative pt-28 pb-8 bg-gradient-to-b from-gray-100 to-zinc-300 ">
      ...
      <div className="absolute bottom-0  foodzone font-bold  font-sans text-xs  md:text-base">
        FOODZONE<span className="md:text-lg ">©</span>2023
      </div>
      <div className="bg-white z-1 rounded  mt-3  pb-6 flex flex-col items-center w-[90%] md:w-[70%] z-20">
        <div className=" flex flex-col justify-center items-center gap-2 mt-2">
          <h2 className="text-3xl md:text-[36px] font-extrabold tracking-widest">
            Stay Connected
          </h2>
          <p className="text-md text-blue-800">
            Encountered any buys? Write down.
          </p>
        </div>
        <div className="form-body flex items-center justify-between  w-full">
          ...
          <div className="form-container flex flex-col justify-start gap-10 items-center">
            ...
            >
              ...
              <motion.button
                {...btnClick}
                className=" hover:border-black border-2 w-40 py-1 text-white bg-black hover:bg-white hover:text-black duration-200"
                type="submit"
                value="send"
              >
