...
const DBLeft = () => {
  return (
    <section className="h-full bg-gradient-to-r from-gray-100 to-gray-300 py-12 hidden md:flex flex-col backdrop-blur-md shadow-md lg:min-w-210 lg:w-300 gap-3 px-[11px] ">
      <NavLink
        to="/"
